...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        ...
        <asp:TextBox ID="CodigoTextBox" runat="server" Width="142px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="CodigoRequiredFieldValidator" runat="server" ErrorMessage="Esta Vacio" ForeColor="Red">*</asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style1"><asp:Label ID="FechaInicio" runat="server" BackColor="#CCCCCC" BorderColor="#999999" Font-Bold="True" ForeColor="#000099" Text="Fecha de Inicio"></asp:Label>
                </td>
                <td>
        ...
        <asp:TextBox ID="FechaFinalTextBox" runat="server" TextMode="Date" Width="159px"></asp:TextBox>
            ...
            <tr>
                <td class="auto-style1"><asp:CheckBox ID="esActivoCheckBox" runat="server" BackColor="Silver" Font-Bold="True" ForeColor="#000099" Text="Activo" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
